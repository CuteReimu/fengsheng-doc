...
::: important 重要
以下所说的**身份**和[**神秘人**任务](../../document/card/secret_task.md)，都指的是游戏开始时分发的，游戏过程中因为技能改变的不算。
:::
...
然后我们可以根据过往的游戏数据得到不同[**神秘人**任务](../../document/card/secret_task.md)胜率。如果你的身份是**神秘人**：
...
::: tip 举例
你是5人局[双面间谍](../../document/card/secret_task.md)，所有身份人均胜率为 $34.88\%$ ，双面间谍胜率为 $29.71\%$ ：

- 你赢了的得分为 $14\times\dfrac{34.88\%}{29.71\%} \approx 16.436$

- 你输了的扣分为 $7\times\dfrac{100\%-34.88\%}{100\%-29.71\%} \approx 5.677$
:::

::: info 特别说明

1. 上述所说的不同[**神秘人**任务](../../document/card/secret_task.md)胜率只计算**不含人机**的对局，并且会根据实时胜率动态变化。
...
3. 如果赢的人平均分比输的人平均分多太多，即使赢了分数也没变化，会影响游戏性。因此我们规定，如果你作为**神秘人**获胜且分差为正，则分差会除以 $max(\dfrac{\text{阵营方单个阵营的人数}}{\text{获胜人数}}, 1.0)$ 后再进行计算。由此，就避免了一个高分**神秘人**单独获胜后，他分数比其他人的平均分高太多，而导致他得分太少的问题。
:::
...
然后，如果你是被[顾小梦](../../document/skills/base.md#g-顾小梦-译电科科员)带赢的，如果这局[顾小梦](../../document/skills/base.md#g-顾小梦-译电科科员)总计带赢了3个人，则[顾小梦](../../document/skills/base.md#g-顾小梦-译电科科员)赢的分数不变，这3个人赢的分数都除以3。
...
- 为防止减分倍率过大导致赢了得 $0$ 分和输了扣 $0$ 分的情况，额外规定：如果你赢了，至少能得 $1$ 分，如果你输了，至少扣 $1$ 分。
