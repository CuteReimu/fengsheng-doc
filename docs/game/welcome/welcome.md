...
::: important 如何注册
在群里输入`注册 名字`（QQ群：::b:qq =17::364857312）即可注册。（例如输入：`注册 惑星`，那么“惑星”就是你的游戏名）
...
[官方规则](../guide/how_to_play.md#一、分发身份牌)中只有5~8人玩法，我们自行扩展了9人玩法。你可以跳转到[**神秘人**列表](../../document/card/secret_task.md)页面查看所有**神秘人**任务的胜利条件。
...
如果你使用了[【试探】](../../document/card/card.md)或者由于某些技能可以确定/排除某名玩家的身份，也会自动给你标记上身份/排除掉对应的选项。

## 卡牌效果

游戏中，Windows上将鼠标悬停在卡牌上/手机端长按卡牌，即可查看卡牌的效果。你也可以跳转到[卡牌列表](../../document/card/card.md)页面查看全部卡牌。
...
你也可以前往[角色技能](../../document/skills)页面查看全部角色。
...
- 如果提示“不再允许开启纯人机房，请和其他玩家一起游戏！”，说明有很多局游戏正在进行，你再一个人打单机很显然是不合时宜的。建议你在房间等待他们完成当前的对局，就可以一起进行游戏了。房间左上角会显示在线人数和当前正在进行游戏的房间数。你也可以跳转到[游戏状态](../game_status.md)页面查看当前正在进行的对局。
