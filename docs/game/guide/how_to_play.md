...
::: info 提示
截止二扩为止一共有7种不同的**神秘人**身份牌。[点击跳转](../../document/card/secret_task.md)
:::
...
当前回合玩家可以从手牌中使用（打出）标注了出牌阶段可以使用的卡牌，如[【试探】](../../document/card/card.md)[【威逼】](../../document/card/card.md)[【利诱】](../../document/card/card.md)。[【试探】](../../document/card/card.md)必须面朝下打出。（玩家可以使用任意数量的手牌，也可以一张都不用）
...
所有玩家都可以从手牌中使用（打出）标注了争夺阶段可以使用的卡牌，如[【截获】](../../document/card/card.md)[【调包】](../../document/card/card.md)[【误导】](../../document/card/card.md)。[【调包】](../../document/card/card.md)必须面朝下打出。（玩家可以使用任意数量的手牌，也可以一张都不用）

除了使用手牌，玩家还可以使用标注了争夺阶段的角色技能，如[“鬼脚（黄包车夫）”的**急送**](../../document/skills/base.md#g-鬼脚-黄包车夫)。
...
当一位玩家进入濒死状态时，由他开始，按照逆时针顺序，依次询问每位玩家是否要使用一张[【澄清】](../../document/card/card.md)。如果无人要使用[【澄清】](../../document/card/card.md)，则濒死玩家立刻<span class="red">死亡</span>。

::: caution 注意
如果某位玩家使用了一张[【澄清】](../../document/card/card.md)后，濒死玩家面前仍有至少三张**黑色**情报，则接着从使用[【澄清】](../../document/card/card.md)的玩家继续询问。
:::

::: warning 注意
最初，濒死结算是由当前回合玩家开始，现已改为由濒死玩家开始。请以[官方FAQ中的濒死结算](../../document/strategy/faq.md#接收情报)为准。
:::
...
2. [【篡夺者】](../../document/card/secret_task.md)身份牌的胜利条件十分苛刻，但如果条件达成，他可以取代他人获得胜利。

> [篡夺者](../../document/card/secret_task.md)：你的回合中，一名角色宣告胜利时，你代替其胜利。
:::

## 游戏细节解释

::: note 笔者注
由于在加入了一扩和二扩后，原说明书上的游戏细节解释已经有些过时了，因此不在此列出。建议跳转到[官方FAQ](../../document/strategy/faq.md)页面查看最新规则解释。
:::
