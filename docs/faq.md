...
例如：**红**&zwnj;**黑**双色情报，就既视为**红色**情报，又视为**黑色**情报，因为含有**黑色**，所以不视为非**黑色**情报。澄清时可以将含黑色的双色情报整张移除。
...
### 簒夺者
- 满足簒夺者身份的获胜条件时，如果该玩家已经达成其他胜利条件，则优先结算其他胜利条件，不结算簒夺者的胜利条件。
- 如果簒夺者在自己的回合死亡，但是在本回合结束前有人宣胜，依旧满足簒夺者的胜利条件。

::: tip 举例
- 二扩角色小九（SP）（情报站长）和韩梅（SP）（军统特务）同时在场，小九身份为簒夺者，小九获得第三张红色情报，此时触发韩梅技能“白月光”和小九共同胜利。韩梅胜利时满足簒夺者的胜利条件，但由于此时小九已经胜利，则不结算簒夺者的胜利条件，不会导致韩梅无法获胜。
:::
