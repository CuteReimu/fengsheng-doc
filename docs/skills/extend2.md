...
## A-阿芙罗拉（苏联间谍）<HopeIcon icon="venus" color="red" />
...
## B-白菲菲（SP）（日本间谍）<HopeIcon icon="venus" color="red" />

- ==**套取**== 出牌阶段限一次，你可以展示两张含有相同颜色的手牌，然后从一名其他角色的情报区把一张对应颜色的情报加入手牌。

## B-边云疆（军人）<HopeIcon icon="mars" color="blue" />
...
## C-陈安娜（速记员）<HopeIcon icon="venus" color="red" />
...
## C-陈大耳（包打听）<HopeIcon icon="mars" color="blue" />
...
## H-韩梅（特务处长）<HopeIcon icon="venus" color="red" />
...
## H-韩梅（SP）（军统特务）<HopeIcon icon="venus" color="red" />
...
## J-金自来（老千）<HopeIcon icon="mars" color="blue" />
...
## X-小九（SP）（情报站长）<HopeIcon icon="mars" color="blue" />
...
## 非正式-孙守謨（参谋）<HopeIcon icon="mars" color="blue" />
...
## 非正式-王响（火车司机）<HopeIcon icon="mars" color="blue" />
