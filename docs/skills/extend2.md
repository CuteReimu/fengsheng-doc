...
## A-<HopeIcon icon="venus" class="red" />阿芙罗拉（苏联间谍）<MaskIcon />
...
## B-<HopeIcon icon="venus" class="red" />白菲菲（SP）（日本间谍）

- ==**套取**== 出牌阶段限一次，你可以展示两张含有相同颜色的手牌，然后从一名其他角色的情报区把一张对应颜色的情报加入手牌。

## B-<HopeIcon icon="mars" class="blue" />边云疆（军人）
...
## C-<HopeIcon icon="venus" class="red" />陈安娜（速记员）
...
## C-<HopeIcon icon="mars" class="blue" />陈大耳（包打听）
...
## H-<HopeIcon icon="venus" class="red" />韩梅（特务处长）<MaskIcon />
...
## H-<HopeIcon icon="venus" class="red" />韩梅（SP）（军统特务）
...
## J-<HopeIcon icon="mars" class="blue" />金自来（老千）
...
## X-<HopeIcon icon="mars" class="blue" />小九（SP）（情报站长）
...
## 非正式-<HopeIcon icon="mars" class="blue" />孙守謨（参谋）
...
## 非正式-<HopeIcon icon="mars" class="blue" />王响（火车司机）
