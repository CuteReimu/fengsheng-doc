...
## A-阿芙罗拉（苏联间谍）<HopeIcon icon="venus" class="red" />
...
## H-韩梅（特务处长）<HopeIcon icon="venus" class="red" />
...
## L-李书云（教授）<HopeIcon icon="venus" class="red" />
...
## X-小九（反特砥柱）<HopeIcon icon="mars" class="blue" />
