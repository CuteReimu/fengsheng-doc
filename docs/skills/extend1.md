...
## C-程小蝶（SP）（梨园义士）<HopeIcon icon="mars" class="blue" />
...
::: tip 关于“观海”技能
- 池静海使用[【误导】](../welcome/welcome.md#卡牌效果)选择目标后，才能发动“观海”技能。
:::

## D-端木静（SP）（学联代表）<HopeIcon icon="venus" class="red" />
...
## L-老虎（地下领袖）<HopeIcon icon="mars" class="blue" />
...
## S-盛老板（富商）<HopeIcon icon="mars" class="blue" />
