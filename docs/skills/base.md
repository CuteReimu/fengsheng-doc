...
## A-阿芙罗拉（赌场荷官）<HopeIcon icon="venus" class="red" />
...
## B-白昆山（军官）<HopeIcon icon="mars" class="blue" />
...
## B-白小年（秘书）<HopeIcon icon="mars" class="blue" />
...
## G-顾小梦（译电科科员）<HopeIcon icon="venus" class="red" />
...
## L-连鸢（作家）<HopeIcon icon="venus" class="red" />

- ==**妙笔巧辩**== 争夺阶段，你可以翻开此角色牌，然后从所有角色的情报区选择合计至多两张不含有相同颜色的情报，将其加入你的手牌。

## L-李宁玉（译电科科长）<HopeIcon icon="venus" class="red" />
...
## L-李醒（租借巡捕）<HopeIcon icon="mars" class="blue" />
...
## M-墨红霜（SP）（危险情人）<HopeIcon icon="venus" class="red" />
...
## S-商玉（酒楼掌柜）<HopeIcon icon="venus" class="red" />
...
## X-小九（报童）<HopeIcon icon="mars" class="blue" />
...
## Z-鄭文先（日伪报社主编）<HopeIcon icon="mars" class="blue" />
