...
- ==**怜悯**== 你传出的**非黑色**情报被接收后，可以从你或接收者的情报区中选择一张**黑色**情报加入你的手牌。
...
- ==**转交**== 你使用一张手牌后，可以从你的情报区选择一张**非黑色**情报，将其置入另一名角色的情报区，然后你摸两张牌。你不能通过此技能让任何角色收集三张或更多同色情报。
...
- ==**急送**== 争夺阶段限一次，你可以弃置两张手牌，或从你的情报区弃置一张**非黑色**情报，然后将待收情报移至一名角色面前。
