...
## A-<HopeIcon icon="venus" class="red" />阿芙罗拉（赌场荷官）<MaskIcon />

- ==**妙手**== 争夺阶段，你可以翻开此角色牌，然后弃置待收情报，并查看一名角色的手牌和情报区，从中选择一张牌作为待收情报，面朝上移至一名角色的面前。

## B-<HopeIcon icon="mars" class="blue" />白沧浪（情场浪子）
...
## B-<HopeIcon icon="venus" class="red" />白菲菲（护士）

- ==**怜悯**== 你传出的非**黑色**情报被接收后，可以从你或接收者的情报区中选择一张**黑色**情报加入你的手牌。
- ==**腹黑**== 你传出的**黑色**情报被接收后，你摸一张牌。

## B-<HopeIcon icon="mars" class="blue" />白昆山（军官）<MaskIcon />
...
## G-<HopeIcon icon="venus" class="red" />顾小梦（SP）（译电科科员）

- ==**羁绊**== 出牌阶段限一次，可以摸两张牌，然后将至少一张手牌交给另一名角色。

## H-<HopeIcon icon="venus" class="red" />韩梅（卖花女）<MaskIcon />

- ==**移花接木**== 争夺阶段，你可以翻开此角色牌，然后从一名角色的情报区选择一张情报，将其置入另一名角色的情报区，若如此做会让其收集三张或更多同色情报，则改为将该牌加入你的手牌。

## H-<HopeIcon icon="mars" class="blue" />黄济仁（药铺大夫）<MaskIcon />

- ==**对症下药**== 争夺阶段，你可以翻开此角色牌，然后摸三张牌，并且你可以展示两张含有相同颜色的手牌，然后从一名角色的情报区，弃置一张对应颜色情报。

## J-<HopeIcon icon="mars" class="blue" />金生火（军机处处长）

- ==**谨慎**== 你接收双色情报后，可以用一张手牌与该情报面朝上互换。

## L-<HopeIcon icon="mars" class="blue" />老鳖（香烟贩子）
...
## L-<HopeIcon icon="venus" class="red" />老汉（裘家二太太）
...
## L-<HopeIcon icon="venus" class="red" />连鸢（作家）<MaskIcon />

- ==**妙笔巧辩**== 争夺阶段，你可以翻开此角色牌，然后从所有角色的情报区选择合计至多两张不含有相同颜色的情报，将其加入你的手牌。

## L-<HopeIcon icon="venus" class="red" />李宁玉（译电科科长）<MaskIcon />
...
## M-<HopeIcon icon="mars" class="blue" />毛不拔（古董商人）
...
## M-<HopeIcon icon="venus" class="red" />墨红霜（SP）（危险情人）<MaskIcon />
...
## P-<HopeIcon icon="venus" class="red" />裴玲（电影明星）

- ==**交际**== 出牌阶段限一次，你可以抽取一名角色的最多两张手牌，然后将等量的手牌交给该角色。你每收集一张**黑色**情报，便可以少交一张手牌。

## S-<HopeIcon icon="venus" class="red" />商玉（酒楼掌柜）<MaskIcon />
...
## Z-<HopeIcon icon="mars" class="blue" />张一挺（司令）
...
## Z-<HopeIcon icon="mars" class="blue" />鄭文先（日伪报社主编）<MaskIcon />
