...
当前回合玩家可以从手牌中使用（打出）标注了出牌阶段可以使用的卡牌，如[【试探】](../welcome/welcome.md#卡牌效果)[【威逼】](../welcome/welcome.md#卡牌效果)[【利诱】](../welcome/welcome.md#卡牌效果)。[【试探】](../welcome/welcome.md#卡牌效果)
必须面朝下打出。（玩家可以使用任意数量的手牌，也可以一张都不用）
...
所有玩家都可以从手牌中使用（打出）标注了争夺阶段可以使用的卡牌，如[【截获】](../welcome/welcome.md#卡牌效果)[【调包】](../welcome/welcome.md#卡牌效果)[【误导】](../welcome/welcome.md#卡牌效果)。[【调包】](../welcome/welcome.md#卡牌效果)
必须面朝下打出。（玩家可以使用任意数量的手牌，也可以一张都不用）
