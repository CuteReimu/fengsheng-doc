...
- 镇压者在自己的回合死亡，并且死亡时拥有不少于两张**红色**和**蓝色**情报，满足镇压者的胜利条件，可以获胜。
...
- 一张**红色**情报加一张**蓝色**情报也满足“两张**红色**或**蓝色**情报”的条件。
- 一张**红**&zwnj;**蓝**双色情报只算一张“**红色**或**蓝色**情报”。

### 清道夫

- 拥有一张**红色**和一张**蓝色**情报的玩家也满足“**红色**和**蓝色**情报均不超过1张”的条件。
...
### 破译
- 情报面朝上时可以使用破译，但即使是**黑色**也不能执行翻开并摸1张牌的效果。可以用来触发一些技能（例如鄭文先**换日**）。

### 截获
- 情报在自己面前时可以使用截获，但并不执行任何操作。可以用来触发一些技能（例如盛老板**深藏**）。
