...
- 如果赢的人平均分比输的人平均分多太多，即使赢了分数也没变化，会影响游戏性。因此我们规定，如果你作为**神秘人**获胜且分差为正，则分差会除以 $max(\dfrac{\text{阵营方单个阵营的人数}}{\text{获胜人数}}, 1.0)$ 后再进行计算。由此，就避免了一个高分**神秘人**单独获胜后，他分数比其他人的平均分高太多，而导致他得分太少的问题。
:::
