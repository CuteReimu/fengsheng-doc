...
3. 如果赢的人平均分比输的人平均分多太多，即使赢了分数也没变化，会影响游戏性。因此我们规定，如果你作为**神秘人**获胜且分差为正，则分差会除以 $max(\dfrac{\text{阵营方单个阵营的人数}}{\text{获胜人数}}, 1.0)$ 后再进行计算，就避免了一个高分神秘人单独获胜后他的平均分比其他人的平均分高太多导致他得分太少的问题。由此，当一个高分玩家作为**神秘人**单独赢了一局时，分数不会增加太少。
:::
