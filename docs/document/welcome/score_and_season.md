...
太长不看：!!最低0分。低于60分每局最多掉2分。只要高于以下分数，无论一局掉多少分，最多掉到该分数，再输一局才会继续掉：0~180分每隔10分，59~62、119~122、179~182、239~242、299~302、359~362中的每1分。!!
...
::: important 重要
以下所说的**身份**和**神秘人**任务，都指的是游戏开始时分发的，游戏过程中因为技能改变的不算。
:::
...
第一步和第二步之间是“**减分则乘算，加分则加算，先乘后加**”的关系。
