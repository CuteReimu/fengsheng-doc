...
- 如果男性角色宣告胜利时，该男性角色的角色牌面朝下，由于面朝下的角色视为无性别（无论是否曾经翻开过），因此秦圆圆无法发动**比翼双飞**技能。
- 如果男性角色宣告胜利时，秦圆圆的角色牌面朝下，由于角色牌面朝下时只能发动“翻开角色牌”的技能，因此秦圆圆无法发动**比翼双飞**技能。
- 如果秦圆圆是[篡夺者](../card/secret_task.md)，在秦圆圆的回合有男性角色宣告胜利，先结算[篡夺者](../card/secret_task.md)的胜利条件，此时导致秦圆圆变为唯一宣告胜利的玩家，因此不会发动**比翼双飞**技能。
- 由于死亡的玩家技能会失效：
