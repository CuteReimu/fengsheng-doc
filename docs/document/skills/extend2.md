...
## A-阿芙罗拉（间谍）<VPIcon icon="venus" class="red" /><MaskIcon />
...
## B-白菲菲（SP）（间谍）<VPIcon icon="venus" class="red" />
...
::: tip 关于“自证清白”技能
- 举个例子，自己是**潜伏战线**，则不可以弃置纯**红色**和含有**红色**的双色情报。
...
## X-小九（反特砥柱）<VPIcon icon="mars" class="blue" /><MaskIcon />
