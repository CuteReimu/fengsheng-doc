...
## B-白沧浪（情场浪子）<VPIcon icon="mars" class="blue" />
...
## B-白菲菲（护士）<VPIcon icon="venus" class="red" />

- ==**怜悯**== 你传出的非**黑色**情报被接收后，可以从你或接收者的情报区中选择一张**黑色**情报加入你的手牌。
- ==**腹黑**== 你传出的**黑色**情报被接收后，你摸一张牌。

## B-白昆山（军官）<VPIcon icon="mars" class="blue" /><MaskIcon />
...
- 只要这个技能开始结算，就会全部结算完毕再开始其它事件的结算，不会在中途被打断。如果此技能导致两名玩家同时拥有3张**黑色**情报，请参考[术语解释 &rarr; 接收阶段](../strategy/faq.md#接收情报)的处理方式。
:::

## B-白小年（秘书）<VPIcon icon="mars" class="blue" />
...
## C-程小蝶（花旦）<VPIcon icon="mars" class="blue" />
...
## D-端木静（学生）<VPIcon icon="venus" class="red" />

- ==**新思潮**== 出牌阶段限一次，你可以弃置一张手牌，然后摸两张牌。

## F-肥原龙川（特务机关长）<VPIcon icon="mars" class="blue" />

- ==**诡诈**== 出牌阶段限一次，你可以指定一名角色，然后视为你对其使用了一张[【威逼】](../card/card.md)或[【利诱】](../card/card.md)。

## G-鬼脚（黄包车夫）<VPIcon icon="mars" class="blue" />

- ==**急送**== 争夺阶段限一次，你可以弃置两张手牌，或从你的情报区弃置一张非**黑色**情报，然后将待收情报移至一名角色面前。

## G-顾小梦（译电科科员）<VPIcon icon="venus" class="red" /><MaskIcon />
...
::: tip 关于“承志”技能
- “若此角色牌已翻开，则你获得其所有手牌，并查看其身份牌”是必须发动的，“获得该身份牌”可以选择是否发动。需要告知他人自己是否选择了“获得该身份牌”，但不应让他人看见你原本的身份牌和新获得的身份牌是什么。
...
- 由于死亡的玩家技能会失效，如果顾小梦已死亡，那么没有身份牌的玩家不会获得胜利。同理，若游戏结束时顾小梦的身份牌面朝下，则同样不会触发**尾声**技能。
:::

## G-顾小梦（SP）（译电科科员）<VPIcon icon="venus" class="red" />
...
## L-老汉（裘家二太太）<VPIcon icon="venus" class="red" />
...
## L-连鸢（作家）<VPIcon icon="venus" class="red" /><MaskIcon />

- ==**妙笔巧辩**== 争夺阶段，你可以翻开此角色牌，然后从所有角色的情报区选择合计至多两张不含有相同颜色的情报，将其加入你的手牌。

## L-李宁玉（译电科科长）<VPIcon icon="venus" class="red" /><MaskIcon />
...
## L-李宁玉（SP）（译电科科长）<VPIcon icon="venus" class="red" />
...
## L-李醒（租借巡捕）<VPIcon icon="mars" class="blue" /><MaskIcon />
...
## M-毛不拔（古董商人）<VPIcon icon="mars" class="blue" />
...
## S-商玉（酒楼掌柜）<VPIcon icon="venus" class="red" /><MaskIcon />
...
## W-吴志国（剿匪大队长）<VPIcon icon="mars" class="blue" />
...
## X-小九（报童）<VPIcon icon="mars" class="blue" /><MaskIcon />

- ==**广发报**== 争夺阶段，你可以翻开此角色牌，然后摸三张牌，并且你可以将你的任意张手牌置入任意名角色的情报区。你不能通过此技能让任何角色收集三张或更多同色情报。

## X-玄青子（算命先生）<VPIcon icon="mars" class="blue" />
...
## Z-张一挺（司令）<VPIcon icon="mars" class="blue" />
...
## Z-鄭文先（日伪报社主编）<VPIcon icon="mars" class="blue" /><MaskIcon />
